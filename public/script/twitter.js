  ...
  twitterjs.domReady((function(options, guid) {
    return function () {
      function render(tweet) {
        ...
        if (options.prefix) {
          html += '<li><span class="twitterPrefix">';
        ...
        html += '<span class="twitterStatus">' + twitterlib.time.relative(tweet.created_at) + '</span> ';
        html += '<span class="twitterTime">' + tweet.text + '</span>';
